...
-- =========================================================
-- SEMILLA: PLANTILLAS PREDETERMINADAS GLOBALES (IS_DEFAULT = TRUE)
-- =========================================================
DO $$
DECLARE
    tpl_ulac_id UUID := 'a0000000-0000-0000-0000-000000000001';
    tpl_bc_id UUID := 'a0000000-0000-0000-0000-000000000002';
    tpl_hang_id UUID := 'a0000000-0000-0000-0000-000000000003';
    tpl_core_id UUID := 'a0000000-0000-0000-0000-000000000004';
BEGIN
    -- 1. ULAC
    INSERT INTO public.workout_templates (id, user_id, title, description, estimated_duration_seconds, is_default)
    VALUES (
        tpl_ulac_id,
        NULL,
        'ULAC (Umbral Láctico Acumulado)',
        'Entrenamiento clásico de resistencia a la fuerza. Mantén una escalada fluida continua.',
        960,
        TRUE
    ) ON CONFLICT (id) DO NOTHING;

    INSERT INTO public.workout_blocks (template_id, position, title, type, sets, work_duration_seconds, rest_duration_seconds, target, notes)
    VALUES (
        tpl_ulac_id,
        0,
        'ULAC 3x1',
        ...
        60,
        'Intensidad 70-75%',
        '4 series de 3 min de trabajo continuo y 1 min de reposo.'
    ...
    VALUES (
        ...
        NULL,
        'BLOQUES CORTOS',
        'Fuerza máxima y coordinación en búlder con intentos de calidad.',
        1680,
        TRUE
    ) ON CONFLICT (id) DO NOTHING;

    INSERT INTO public.workout_blocks (template_id, position, title, type, problems, movements, attempts, rest_duration_seconds, target, notes)
    VALUES (
        tpl_bc_id,
        0,
        ...
        90,
        'RPE 9 - Proyectos',
        '4 problemas de 5 movimientos. Máximo 4 intentos por bloque.'
    ) ON CONFLICT DO NOTHING;

    -- 3. Suspensiones 20 mm
    INSERT INTO public.workout_templates (id, user_id, title, description, estimated_duration_seconds, is_default)
    VALUES (
        tpl_hang_id,
        NULL,
        'Suspensiones 20 mm (Max Hangs)',
        'Fuerza máxima de dedos en regleta de 20 mm con descanso completo.',
        1122,
        TRUE
    ) ON CONFLICT (id) DO NOTHING;
    ...
    VALUES (
        ...
        180,
        'Semiarqueo estricto',
        '6 series de 7 segundos con 3 minutos de reposo.'
    ) ON CONFLICT DO NOTHING;
    ...
    VALUES (
        tpl_core_id,
        NULL,
        'Core Específico para Escalada',
        'Tensión corporal y estabilidad para mantener los pies pegados a la pared.',
        306,
        TRUE
    ) ON CONFLICT (id) DO NOTHING;

    INSERT INTO public.workout_blocks (template_id, position, title, type, sets, repetitions, rest_duration_seconds, target, notes)
    VALUES (
        tpl_core_id,
        0,
        'Dragon Flags / L-Sit',
        ...
        60,
        'Control excéntrico',
        '3 series de 12 repeticiones con 1 min de descanso.'
    ) ON CONFLICT DO NOTHING;
END $$;
