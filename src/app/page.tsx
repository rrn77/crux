...
export default function HomePage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight leading-tight">
              {featuredTemplate ? featuredTemplate.title : 'Entrenamiento Personalizado'}
            </h1>
            <p className="text-xs sm:text-sm text-white/90 mt-1 line-clamp-2">
              {featuredTemplate
                ? featuredTemplate.description
                : 'Crea tu propia sesión con bloques a medida o usa una plantilla.'}
            </p>
          </div>
      ...
      {/* 3. Plantillas Rápidas Destacadas */}
